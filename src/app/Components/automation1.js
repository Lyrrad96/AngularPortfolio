app.controller("automationCntrl", function ($scope, $rootScope, $http, $timeout, $location, $filter, $sce, tasAlert, tasService, uiGridConstants) {
    ...
    var columnDefs = [
        ...
        },
        {
            headerName: 'super Col 2', children: [
                {
                    headerName: 'super sub Col 2', children: [{
                        field: 'gold',
                    },
                    {
                        field: 'silver',
    ...
    class headerGroupSelect {
        ...
        setupGui(params) {
            ...
            $timeout(() => {
                var html =
                    `
                    <div class="ag-header-group-cell-label" ref="agContainer" role="presentation" ng-click="selectColumnGroup(this)">
    ...
    $scope.configArray = Array(1).fill($scope.aggridconfig)
    ...
    //     .then((data) => $scope.aggridfig['rowData'] = /* Array(2866).fill */(data).flat().slice(0, 1000))
    //     .then(() => $scope.aggridfig.scope.initGrid($scope.aggridfig))
